...
import { ArenasByIdService } from "./arenas-id.service";
...
describe('ArenasByIdService',()=>{
    let service:ArenasByIdService;
    ...
    beforeEach(()=>{
        service = TestBed.inject(ArenasByIdService)
   ...
   it('Get arena row by id',()=>{ 
        service.findById(arenaId).subscribe((res:any)=>{
